...
(function()
{
	...
	if (typeof crossStorageClientHUB == 'undefined'){
		...
		if (typeof Promise == 'undefined'){
			loadScript("http://www.zdf.de/ZDFxt/module/socialoptin/js/libs/es6-promise-2.0.0.min.js", function(){
				loadScript("http://www.zdf.de/ZDFxt/module/socialoptin/js/cross-storage/client-0.3.3.js", execscripts);				
			});			
		} else {
			loadScript("http://www.zdf.de/ZDFxt/module/socialoptin/js/cross-storage/client-0.3.3.js", execscripts);			
		}
